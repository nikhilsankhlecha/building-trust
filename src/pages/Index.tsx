...
const products = [
  {
    ...
    image: heroProduct,
    specs: { coverage: '18-20 m²/25kg', setting: '45-60 min', thickness: '10-15mm' },
    tag: 'Best Seller',
  },
  {
    ...
    image: gypsumBoards,
    specs: { size: '1200x2400mm', thickness: '12.5mm', fire: '2 hr rating' },
    tag: 'Fire Rated',
  },
  {
    ...
    specs: { coverage: '25-30 m²/25kg', setting: '30-45 min', application: 'Manual' },
    tag: 'Premium',
  },
  {
    ...
    specs: { size: '1200x3000mm', thickness: '15mm', acoustic: '45 STC' },
    tag: 'Acoustic',
  },
];

const applications = [
  { name: 'Ceilings', icon: Building, description: 'False ceilings and decorative finishes' },
  { name: 'Partitions', icon: Home, description: 'Drywall systems for flexible spaces' },
  { name: 'Wall Plastering', icon: Building2, description: 'Interior walls for all building types' },
];
...
const clientLogos = [
  'Buildon Group', 'Hi-Tech Constructions', 'Urban Developers', 'Metro Builders', 'Prime Infra', 'Delta Projects'
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative animate-fade-up" style={{ animationDelay: '0.2s' }}>
              <div className="relative z-10">
                <img 
                  src={ceilingApplication} 
                  alt="Premium gypsum plastered interior" 
        ...
        <div className="container-wide px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-16">
            {clientLogos.map((logo, index) => (
              <div 
                key={logo} 
                className="text-primary-foreground/40 font-heading font-semibold text-lg"
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-xs text-muted-foreground mb-4">
                    {Object.entries(product.specs).map(([key, value]) => (
                      <div key={key} className="bg-secondary rounded px-2 py-1 text-center">
        ...
        <div className="container-wide section-padding">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {applications.map((app, index) => (
              <div 
                key={app.name}
                className="bg-card p-8 rounded-xl border border-border text-center card-hover"
              >
